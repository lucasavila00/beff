...
it("optionality", () => {
  ...
  expect(Codecs.BeforeRequired.describe()).toMatchInlineSnapshot(
    '"type CodecBeforeRequired = { a: string, b: (null | string), c: (null | string), d: (null | string), e: (null | string) };"',
  );
  expect(
  ...
  expect(Codecs.AfterRequired.describe()).toMatchInlineSnapshot(
    '"type CodecAfterRequired = { a: string, b: (null | string), c: (null | string), d: (null | string), e: string };"',
  );
