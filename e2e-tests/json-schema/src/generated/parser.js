...
const direct_hoist_20 = new RefRuntype(undefined, "EmptyClosedRecord");
const direct_hoist_21 = new RefRuntype(undefined, "OptionalNullishInput");
const direct_hoist_22 = new RefRuntype(undefined, "ToolInput");
const direct_hoist_23 = new ConstRuntype(undefined, "a1");
const direct_hoist_24 = new ConstRuntype(undefined, "a");
const direct_hoist_25 = new ObjectRuntype(undefined, {
    "a1": direct_hoist_0,
    "a11": new OptionalFieldRuntype(direct_hoist_0),
    "subType": direct_hoist_23,
    "type": direct_hoist_24
}, []);
const direct_hoist_26 = new ConstRuntype(undefined, "a2");
const direct_hoist_27 = new ObjectRuntype(undefined, {
    "a2": direct_hoist_0,
    "subType": direct_hoist_26,
    "type": direct_hoist_24
}, []);
const direct_hoist_28 = new AnyOfDiscriminatedRuntype(undefined, [
    direct_hoist_25,
    direct_hoist_27
], "subType", {
    "a1": direct_hoist_25,
...
const direct_hoist_29 = new ConstRuntype(undefined, "b");
const direct_hoist_30 = new ObjectRuntype(undefined, {
    "type": direct_hoist_29,
    "value": direct_hoist_1
}, []);
const direct_hoist_31 = new AnyOfDiscriminatedRuntype(undefined, [
    direct_hoist_25,
    direct_hoist_27,
    direct_hoist_30
], "type", {
...
const direct_hoist_35 = new NeverRuntype(undefined);
...
const direct_hoist_37 = new BigIntRuntype(undefined);
const direct_hoist_38 = new ObjectRuntype(undefined, {
    "x": direct_hoist_37
}, []);
const direct_hoist_39 = new DateRuntype(undefined);
const direct_hoist_40 = new ObjectRuntype(undefined, {
    "x": direct_hoist_39
}, []);
const direct_hoist_41 = new TupleRuntype(undefined, [
    direct_hoist_0
], direct_hoist_0);
const direct_hoist_42 = new AnyOfRuntype(undefined, [
    direct_hoist_3,
    direct_hoist_4,
    direct_hoist_1
]);
...
const direct_hoist_44 = new ObjectRuntype(undefined, {
    "limit": new OptionalFieldRuntype(direct_hoist_42),
    "value": new OptionalFieldRuntype(direct_hoist_43)
}, []);
const direct_hoist_45 = new ArrayRuntype(undefined, direct_hoist_16);
const direct_hoist_46 = new ObjectRuntype(undefined, {
    "children": direct_hoist_45,
    "value": direct_hoist_1
}, []);
const direct_hoist_47 = new RegexRuntype(undefined, /(\d+(\.\d+)?)(\.)(\d+(\.\d+)?)(\.)(\d+(\.\d+)?)/, "`${number}.${number}.${number}`");
...
const direct_hoist_50 = new ArrayRuntype(undefined, direct_hoist_11);
const direct_hoist_51 = new ObjectRuntype(undefined, {
    "t2Array": direct_hoist_50
}, []);
const direct_hoist_52 = new ConstRuntype(undefined, "stock_picker");
const direct_hoist_53 = new ObjectRuntype(undefined, {
    "key": direct_hoist_52
}, []);
const direct_hoist_54 = new RefRuntype(undefined, "ToolEnvelope");
const direct_hoist_55 = new RefRuntype(undefined, "WorkflowInput");
const direct_hoist_56 = new AllOfRuntype(undefined, [
    direct_hoist_54,
    direct_hoist_55
]);
const direct_hoist_57 = new StringWithFormatRuntype(undefined, [
    "ValidCurrency"
]);
...
const namedRuntypes = {
    "DiscriminatedUnion": direct_hoist_31,
    "DocumentedPayload": direct_hoist_34,
    "EmptyClosedRecord": direct_hoist_36,
    "InvalidSchemaWithBigInt": direct_hoist_38,
    "InvalidSchemaWithDate": direct_hoist_40,
    "NonEmptyString": direct_hoist_41,
    "OptionalNullishInput": direct_hoist_44,
    "RecursiveTree": direct_hoist_46,
    "SemVer": direct_hoist_47,
    "T1": direct_hoist_48,
    "T2": direct_hoist_49,
    "T3": direct_hoist_51,
    "ToolEnvelope": direct_hoist_53,
    "ToolInput": direct_hoist_56,
    "ValidCurrency": direct_hoist_57,
    "WorkflowInput": direct_hoist_58
};
const buildParsersInput = {
    ...
    "EmptyClosedRecord": direct_hoist_20,
    "OptionalNullishInput": direct_hoist_21,
    "ToolInput": direct_hoist_22
};
