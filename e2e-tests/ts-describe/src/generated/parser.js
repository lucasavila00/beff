...
const namedRuntypes = {
    ...
    "T3": new ObjectRuntype({
        "t2Array": {
            "_tag": "Required",
            "t": new ArrayRuntype(new RefRuntype("T2"))
        }
    }, []),
    ...
    "RecursiveTree": new ObjectRuntype({
        "children": {
            "_tag": "Required",
            "t": new ArrayRuntype(new RefRuntype("RecursiveTree"))
        },
        "value": {
            "_tag": "Required",
            "t": direct_hoist_1
...
const buildParsersInput = {
    ...
    "undefined": new UndefinedRuntype(),
