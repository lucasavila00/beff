...
const hoisted_15 = new ParserRefImpl("ReusesRef");
const hoisted_16 = new ParserDateImpl();
const hoisted_17 = new ParserBigIntImpl();
const hoisted_18 = new ParserConstImpl("a1");
const hoisted_19 = new ParserConstImpl("a");
const hoisted_2 = new ParserTypeOfImpl("boolean");
const hoisted_20 = new ParserConstImpl("a2");
const hoisted_21 = new ParserConstImpl("b");
...
const namedParsers = {
    ...
    "ReusesRef": new ParserObjectImpl({
        "a": hoisted_7,
        "b": hoisted_7
    }, null)
};
