...
const direct_hoist_15 = new ParserRefImpl("ReusesRef");
const direct_hoist_16 = new ParserDateImpl();
const direct_hoist_17 = new ParserBigIntImpl();
const direct_hoist_18 = new ParserConstImpl("a1");
const direct_hoist_19 = new ParserConstImpl("a");
const direct_hoist_2 = new ParserTypeOfImpl("boolean");
const direct_hoist_20 = new ParserConstImpl("a2");
const direct_hoist_21 = new ParserConstImpl("b");
const direct_hoist_22 = new ParserStringWithFormatImpl([
    "ValidCurrency"
]);
...
const namedParsers = {
    ...
    "ReusesRef": new ParserHoistedImpl(18)
};
