...
it("works", () => {
  ...
  expect(Codecs.undefined.describe()).toMatchInlineSnapshot('"type Codecundefined = undefined;"');
  ...
  expect(Codecs.DiscriminatedUnion.describe()).toMatchInlineSnapshot(
    '"type CodecDiscriminatedUnion = ({ a2: string, subType: \\"a2\\", type: \\"a\\" } | { type: \\"b\\", value: number } | { a1: string, a11?: string, subType: \\"a1\\", type: \\"a\\" });"',
  );
