...
const direct_hoist_67 = new ObjectRuntype({
    "a1": direct_hoist_3,
    "a11": new OptionalField(direct_hoist_3),
...
const direct_hoist_74 = new ObjectRuntype({
    "type": new OptionalField(direct_hoist_73),
...
const direct_hoist_93 = new ObjectRuntype({
    "a": new OptionalField(direct_hoist_90),
    "b": new OptionalField(direct_hoist_91)
}, []);
const direct_hoist_94 = new ObjectRuntype({
    "A": direct_hoist_3
}, []);
const direct_hoist_95 = new ObjectRuntype({
    "a": new OptionalField(direct_hoist_3),
    "b": new OptionalField(direct_hoist_7)
}, []);
const direct_hoist_96 = new ObjectRuntype({
    "a": new OptionalField(direct_hoist_3),
    "b": new OptionalField(direct_hoist_3)
}, []);
const direct_hoist_97 = new ObjectRuntype({
    "a": new OptionalField(direct_hoist_3),
    "d": new OptionalField(direct_hoist_87),
    "level": new OptionalField(direct_hoist_88)
}, []);
...
const direct_hoist_100 = new ObjectRuntype({
    "sizes": new OptionalField(direct_hoist_99)
}, []);
...
const direct_hoist_131 = new ObjectRuntype({
    "optional": new OptionalField(direct_hoist_3)
}, []);
