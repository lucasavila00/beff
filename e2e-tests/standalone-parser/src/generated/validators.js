...
function ValidateTransportedValue(ctx, input) {
    return (hoisted_TransportedValue_2.validateAnyOfDecoder.bind(hoisted_TransportedValue_2))(ctx, input);
}
function ValidateOnlyAKey(ctx, input) {
    return (hoisted_OnlyAKey_0.validateObjectDecoder.bind(hoisted_OnlyAKey_0))(ctx, input);
}
...
function ValidateAObject(ctx, input) {
    return (hoisted_AObject_1.validateObjectDecoder.bind(hoisted_AObject_1))(ctx, input);
}
...
function ValidateOmitSettings(ctx, input) {
    return (hoisted_OmitSettings_3.validateObjectDecoder.bind(hoisted_OmitSettings_3))(ctx, input);
}
function ValidateSettings(ctx, input) {
    return (hoisted_Settings_3.validateObjectDecoder.bind(hoisted_Settings_3))(ctx, input);
}
function ValidatePartialObject(ctx, input) {
    return (hoisted_PartialObject_2.validateObjectDecoder.bind(hoisted_PartialObject_2))(ctx, input);
}
function ValidateRequiredPartialObject(ctx, input) {
    return (hoisted_RequiredPartialObject_0.validateObjectDecoder.bind(hoisted_RequiredPartialObject_0))(ctx, input);
}
function ValidateLevelAndDSettings(ctx, input) {
    return (hoisted_LevelAndDSettings_3.validateObjectDecoder.bind(hoisted_LevelAndDSettings_3))(ctx, input);
}
function ValidatePartialSettings(ctx, input) {
    return (hoisted_PartialSettings_7.validateObjectDecoder.bind(hoisted_PartialSettings_7))(ctx, input);
}
function ValidateExtra(ctx, input) {
    return (hoisted_Extra_0.validateObjectDecoder.bind(hoisted_Extra_0))(ctx, input);
}
...
function ValidateUser(ctx, input) {
    return (hoisted_User_1.validateObjectDecoder.bind(hoisted_User_1))(ctx, input);
}
function ValidatePublicUser(ctx, input) {
    return (hoisted_PublicUser_0.validateObjectDecoder.bind(hoisted_PublicUser_0))(ctx, input);
}
function ValidateReq(ctx, input) {
    return (hoisted_Req_0.validateObjectDecoder.bind(hoisted_Req_0))(ctx, input);
}
function ValidateWithOptionals(ctx, input) {
    return (hoisted_WithOptionals_1.validateObjectDecoder.bind(hoisted_WithOptionals_1))(ctx, input);
}
function ValidateRepro1(ctx, input) {
    return (hoisted_Repro1_1.validateObjectDecoder.bind(hoisted_Repro1_1))(ctx, input);
}
function ValidateRepro2(ctx, input) {
    return (hoisted_Repro2_0.validateObjectDecoder.bind(hoisted_Repro2_0))(ctx, input);
}
function ValidateSettingsUpdate(ctx, input) {
    return (hoisted_SettingsUpdate_2.validateAnyOfDecoder.bind(hoisted_SettingsUpdate_2))(ctx, input);
}
function ValidateMapped(ctx, input) {
    return (hoisted_Mapped_4.validateObjectDecoder.bind(hoisted_Mapped_4))(ctx, input);
}
function ValidateMappedOptional(ctx, input) {
    return (hoisted_MappedOptional_6.validateObjectDecoder.bind(hoisted_MappedOptional_6))(ctx, input);
}
function ValidateDiscriminatedUnion(ctx, input) {
    return (hoisted_DiscriminatedUnion_5.validateAnyOfDiscriminatedDecoder.bind(hoisted_DiscriminatedUnion_5))(ctx, input);
}
function ValidateDiscriminatedUnion2(ctx, input) {
    return (hoisted_DiscriminatedUnion2_12.validateAnyOfDecoder.bind(hoisted_DiscriminatedUnion2_12))(ctx, input);
}
function ValidateDiscriminatedUnion3(ctx, input) {
    return (hoisted_DiscriminatedUnion3_3.validateAnyOfDiscriminatedDecoder.bind(hoisted_DiscriminatedUnion3_3))(ctx, input);
}
function ValidateDiscriminatedUnion4(ctx, input) {
    return (hoisted_DiscriminatedUnion4_7.validateAnyOfDiscriminatedDecoder.bind(hoisted_DiscriminatedUnion4_7))(ctx, input);
}
...
function ValidateUnionWithEnumAccess(ctx, input) {
    return (hoisted_UnionWithEnumAccess_3.validateAnyOfDiscriminatedDecoder.bind(hoisted_UnionWithEnumAccess_3))(ctx, input);
}
function ValidateShape(ctx, input) {
    return (hoisted_Shape_3.validateAnyOfDiscriminatedDecoder.bind(hoisted_Shape_3))(ctx, input);
}
function ValidateT3(ctx, input) {
    return (hoisted_T3_2.validateAnyOfDiscriminatedDecoder.bind(hoisted_T3_2))(ctx, input);
}
function ValidateBObject(ctx, input) {
    return (hoisted_BObject_1.validateObjectDecoder.bind(hoisted_BObject_1))(ctx, input);
}
function ValidateDEF(ctx, input) {
    return (hoisted_DEF_0.validateObjectDecoder.bind(hoisted_DEF_0))(ctx, input);
}
...
function ValidateABC(ctx, input) {
    return (hoisted_ABC_0.validateObjectDecoder.bind(hoisted_ABC_0))(ctx, input);
}
function ValidateKABC(ctx, input) {
    return (validateNever)(ctx, input);
}
function ValidateK(ctx, input) {
    return (hoisted_K_0.validateAnyOfDecoder.bind(hoisted_K_0))(ctx, input);
}
const validators = {
...
const hoisted_TransportedValue_1 = new ArrayDecoder(hoisted_TransportedValue_0.validateAnyOfDecoder.bind(hoisted_TransportedValue_0));
const hoisted_TransportedValue_2 = new AnyOfDecoder([
    validateNull,
    validateString,
    hoisted_TransportedValue_1.validateArrayDecoder.bind(hoisted_TransportedValue_1)
]);
...
const hoisted_OmitSettings_3 = new ObjectDecoder({
    "d": hoisted_OmitSettings_1.validateObjectDecoder.bind(hoisted_OmitSettings_1),
    "level": hoisted_OmitSettings_2.validateAnyOfConstsDecoder.bind(hoisted_OmitSettings_2)
});
...
const hoisted_Settings_3 = new ObjectDecoder({
    "a": validateString,
    "d": hoisted_Settings_1.validateObjectDecoder.bind(hoisted_Settings_1),
    "level": hoisted_Settings_2.validateAnyOfConstsDecoder.bind(hoisted_Settings_2)
});
...
const hoisted_PartialObject_2 = new ObjectDecoder({
    "a": hoisted_PartialObject_0.validateAnyOfDecoder.bind(hoisted_PartialObject_0),
    "b": hoisted_PartialObject_1.validateAnyOfDecoder.bind(hoisted_PartialObject_1)
});
...
const hoisted_LevelAndDSettings_3 = new ObjectDecoder({
    "d": hoisted_LevelAndDSettings_1.validateObjectDecoder.bind(hoisted_LevelAndDSettings_1),
    "level": hoisted_LevelAndDSettings_2.validateAnyOfConstsDecoder.bind(hoisted_LevelAndDSettings_2)
});
...
const hoisted_PartialSettings_2 = new ObjectDecoder({
    "tag": hoisted_PartialSettings_1.validateConstDecoder.bind(hoisted_PartialSettings_1)
});
const hoisted_PartialSettings_3 = new AnyOfDecoder([
    validateNull,
    hoisted_PartialSettings_2.validateObjectDecoder.bind(hoisted_PartialSettings_2)
]);
...
const hoisted_PartialSettings_6 = new AnyOfDecoder([
    validateNull,
    hoisted_PartialSettings_4.validateConstDecoder.bind(hoisted_PartialSettings_4),
    hoisted_PartialSettings_5.validateConstDecoder.bind(hoisted_PartialSettings_5)
]);
const hoisted_PartialSettings_7 = new ObjectDecoder({
    "a": hoisted_PartialSettings_0.validateAnyOfDecoder.bind(hoisted_PartialSettings_0),
    "d": hoisted_PartialSettings_3.validateAnyOfDecoder.bind(hoisted_PartialSettings_3),
    "level": hoisted_PartialSettings_6.validateAnyOfDecoder.bind(hoisted_PartialSettings_6)
});
const hoisted_Extra_0 = new ObjectDecoder({}, validateString);
...
const hoisted_User_1 = new ObjectDecoder({
    ...
    "friends": hoisted_User_0.validateArrayDecoder.bind(hoisted_User_0),
    "name": validateString
});
...
const hoisted_WithOptionals_1 = new ObjectDecoder({
    "optional": hoisted_WithOptionals_0.validateAnyOfDecoder.bind(hoisted_WithOptionals_0)
});
...
const hoisted_Repro1_1 = new ObjectDecoder({
    "sizes": hoisted_Repro1_0.validateAnyOfDecoder.bind(hoisted_Repro1_0)
});
...
const hoisted_SettingsUpdate_2 = new AnyOfDecoder([
    validateString,
    hoisted_SettingsUpdate_1.validateObjectDecoder.bind(hoisted_SettingsUpdate_1)
]);
...
const hoisted_Mapped_3 = new ObjectDecoder({
    "value": hoisted_Mapped_2.validateConstDecoder.bind(hoisted_Mapped_2)
});
const hoisted_Mapped_4 = new ObjectDecoder({
    "a": hoisted_Mapped_1.validateObjectDecoder.bind(hoisted_Mapped_1),
    "b": hoisted_Mapped_3.validateObjectDecoder.bind(hoisted_Mapped_3)
});
...
const hoisted_MappedOptional_2 = new AnyOfDecoder([
    validateNull,
    hoisted_MappedOptional_1.validateObjectDecoder.bind(hoisted_MappedOptional_1)
]);
const hoisted_MappedOptional_3 = new ConstDecoder("b");
const hoisted_MappedOptional_4 = new ObjectDecoder({
    "value": hoisted_MappedOptional_3.validateConstDecoder.bind(hoisted_MappedOptional_3)
});
const hoisted_MappedOptional_5 = new AnyOfDecoder([
    validateNull,
    hoisted_MappedOptional_4.validateObjectDecoder.bind(hoisted_MappedOptional_4)
]);
const hoisted_MappedOptional_6 = new ObjectDecoder({
    "a": hoisted_MappedOptional_2.validateAnyOfDecoder.bind(hoisted_MappedOptional_2),
    "b": hoisted_MappedOptional_5.validateAnyOfDecoder.bind(hoisted_MappedOptional_5)
});
...
const hoisted_DiscriminatedUnion_1 = new ObjectDecoder({
    "a1": validateString,
    "a11": hoisted_DiscriminatedUnion_0.validateAnyOfDecoder.bind(hoisted_DiscriminatedUnion_0)
});
...
const hoisted_DiscriminatedUnion_3 = new AnyOfDiscriminatedDecoder("subType", {
    "a1": hoisted_DiscriminatedUnion_1.validateObjectDecoder.bind(hoisted_DiscriminatedUnion_1),
    "a2": hoisted_DiscriminatedUnion_2.validateObjectDecoder.bind(hoisted_DiscriminatedUnion_2)
});
...
const hoisted_DiscriminatedUnion_5 = new AnyOfDiscriminatedDecoder("type", {
    "a": hoisted_DiscriminatedUnion_3.validateAnyOfDiscriminatedDecoder.bind(hoisted_DiscriminatedUnion_3),
    "b": hoisted_DiscriminatedUnion_4.validateObjectDecoder.bind(hoisted_DiscriminatedUnion_4)
});
...
const hoisted_DiscriminatedUnion2_3 = new ObjectDecoder({
    "a1": validateString,
    "a11": hoisted_DiscriminatedUnion2_0.validateAnyOfDecoder.bind(hoisted_DiscriminatedUnion2_0),
    "subType": hoisted_DiscriminatedUnion2_1.validateConstDecoder.bind(hoisted_DiscriminatedUnion2_1),
    "type": hoisted_DiscriminatedUnion2_2.validateConstDecoder.bind(hoisted_DiscriminatedUnion2_2)
});
...
const hoisted_DiscriminatedUnion2_8 = new AnyOfDecoder([
    validateNull,
    hoisted_DiscriminatedUnion2_7.validateConstDecoder.bind(hoisted_DiscriminatedUnion2_7)
]);
const hoisted_DiscriminatedUnion2_9 = new ObjectDecoder({
    "type": hoisted_DiscriminatedUnion2_8.validateAnyOfDecoder.bind(hoisted_DiscriminatedUnion2_8),
...
const hoisted_DiscriminatedUnion2_11 = new ObjectDecoder({
    "type": hoisted_DiscriminatedUnion2_10.validateConstDecoder.bind(hoisted_DiscriminatedUnion2_10),
    "value": validateNumber
});
const hoisted_DiscriminatedUnion2_12 = new AnyOfDecoder([
    hoisted_DiscriminatedUnion2_3.validateObjectDecoder.bind(hoisted_DiscriminatedUnion2_3),
    hoisted_DiscriminatedUnion2_6.validateObjectDecoder.bind(hoisted_DiscriminatedUnion2_6),
    hoisted_DiscriminatedUnion2_9.validateObjectDecoder.bind(hoisted_DiscriminatedUnion2_9),
    hoisted_DiscriminatedUnion2_11.validateObjectDecoder.bind(hoisted_DiscriminatedUnion2_11)
]);
...
const hoisted_DiscriminatedUnion3_3 = new AnyOfDiscriminatedDecoder("type", {
    "a": hoisted_DiscriminatedUnion3_0.validateObjectDecoder.bind(hoisted_DiscriminatedUnion3_0),
    "b": hoisted_DiscriminatedUnion3_1.validateObjectDecoder.bind(hoisted_DiscriminatedUnion3_1),
    "c": hoisted_DiscriminatedUnion3_2.validateObjectDecoder.bind(hoisted_DiscriminatedUnion3_2)
});
...
const hoisted_DiscriminatedUnion4_2 = new ObjectDecoder({
    "a": hoisted_DiscriminatedUnion4_1.validateObjectDecoder.bind(hoisted_DiscriminatedUnion4_1)
});
const hoisted_DiscriminatedUnion4_3 = new ConstDecoder("a2");
const hoisted_DiscriminatedUnion4_4 = new ObjectDecoder({
    "a2": validateString,
    "subType": hoisted_DiscriminatedUnion4_3.validateConstDecoder.bind(hoisted_DiscriminatedUnion4_3)
});
const hoisted_DiscriminatedUnion4_5 = new ObjectDecoder({
    "a": hoisted_DiscriminatedUnion4_4.validateObjectDecoder.bind(hoisted_DiscriminatedUnion4_4)
});
const hoisted_DiscriminatedUnion4_6 = new AnyOfDecoder([
    hoisted_DiscriminatedUnion4_2.validateObjectDecoder.bind(hoisted_DiscriminatedUnion4_2),
    hoisted_DiscriminatedUnion4_5.validateObjectDecoder.bind(hoisted_DiscriminatedUnion4_5)
]);
const hoisted_DiscriminatedUnion4_7 = new AnyOfDiscriminatedDecoder("type", {
    "a": hoisted_DiscriminatedUnion4_6.validateAnyOfDecoder.bind(hoisted_DiscriminatedUnion4_6)
});
...
const hoisted_UnionWithEnumAccess_3 = new AnyOfDiscriminatedDecoder("tag", {
    "a": hoisted_UnionWithEnumAccess_0.validateObjectDecoder.bind(hoisted_UnionWithEnumAccess_0),
    "b": hoisted_UnionWithEnumAccess_1.validateObjectDecoder.bind(hoisted_UnionWithEnumAccess_1),
    "c": hoisted_UnionWithEnumAccess_2.validateObjectDecoder.bind(hoisted_UnionWithEnumAccess_2)
});
...
const hoisted_Shape_3 = new AnyOfDiscriminatedDecoder("kind", {
    "circle": hoisted_Shape_0.validateObjectDecoder.bind(hoisted_Shape_0),
    "square": hoisted_Shape_1.validateObjectDecoder.bind(hoisted_Shape_1),
    "triangle": hoisted_Shape_2.validateObjectDecoder.bind(hoisted_Shape_2)
});
...
const hoisted_T3_2 = new AnyOfDiscriminatedDecoder("kind", {
    "square": hoisted_T3_0.validateObjectDecoder.bind(hoisted_T3_0),
    "triangle": hoisted_T3_1.validateObjectDecoder.bind(hoisted_T3_1)
});
